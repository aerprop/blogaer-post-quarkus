...
public class Draft {
    ...
    public String getContentText() { return contentText; }  
    public void setContentText(String contentText) { this.contentText = contentText; } public List<Object> getContent() { return content; }
    ...
    public String toString() {
        return MessageFormat.format("Draft [id={0}, userId={1}, title={2}, content={3}, categories={4}, tags={5}, comments={6}, thoughts={7}, reads={8}, createdAt={9}, updatedAt={10}]", id, userId, title, content, categories, tags, comments, thoughts, reads, createdAt, updatedAt);
    }
}
